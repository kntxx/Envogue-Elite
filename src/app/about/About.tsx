...
const Aboutus = () => {
  return (
    ...
    >
      <div className="container mx-auto mt-11 md:mt-0">
        <div className="flex flex-col text-center md:text-left  justify-between items-center space-y-5 md:flex-row mt-11">
          <motion.div
          ...
          >
            <Image
              ...
              height="500"
              alt=""
              className="w-[240px] md:w-[300px] lg:w-[360px] h-full "
            />
          </motion.div>
